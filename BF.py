# -*- coding: utf-8 -*-
"""
Created on Sun May 25 21:23:09 2025
...
#         self.time_weight = 0    # 时间衰减权重
#         self.td_weight = 1      # TD误差权重
...
class ReplayTree:
    def __init__(self, capacity):
        ...
        self.beta = 0.4
        # 调整权重参数（总和为1）
        self.td_weight = 0.5      # TD误差权重
        self.time_weight = 0.3    # 时间衰减权重
        self.reward_weight = 0.2  # 新增奖励函数权重
        self.time_steps = {}      
...
class DQN(object):
    ...
    def learn(self):                                                            # 定义学习函数(记忆库已满后便开始学习)
        ...
        np.save('loss_listp6.npy', loss_list)
        # # 抽取记忆库中的批数据
